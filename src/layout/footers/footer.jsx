...
const footer_contents = {
  logo: '/assets/img/logo/logo_tattoobox.png',
  widget_desc:
  ...
  copy_right_text: (
    <>
      © Copyright ©{new Date().getFullYear()} Collax. All Rights Reserved
      Copyright
    </>
  ),
...
const Footer = ({ home_four = false }) => {
  return (
    <React.Fragment>
      <footer>
        <div className='tp-footer-area secundary-bg pt-130 pb-30'>
